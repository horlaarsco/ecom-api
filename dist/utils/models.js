        ...
        user: function (_, _a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, model_1.default.findById(id)];
                        case 1:
                            user = _b.sent();
    ...
    Mutation: {
        ...
        editUser: function (_, _a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, model_1.default.findByIdAndUpdate(id)];
                        case 1:
                            user = _b.sent();
        ...
        deleteUser: function (_, _a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, model_1.default.findByIdAndDelete(id)];
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, user];
                    }
